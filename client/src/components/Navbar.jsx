        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            {user && (
              <Link
                to={"/cart"}
                className="relative group text-yellow-200 hover:text-yellow-400 transition duration-300 
							ease-in-out"
              >
                <ShoppingCart
                ...
                {cart.length > 0 && (
                  <span
                    className="absolute -top-2 -left-2 bg-yellow-800 text-white rounded-full px-2 py-0.5 
